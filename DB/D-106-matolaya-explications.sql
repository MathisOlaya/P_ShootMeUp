/*___________                .__   .__                   __   .__                             _________________   .____     
  \_   _____/___  _________  |  |  |__|  ____  _____   _/  |_ |__|  ____    ____    ______   /   _____/\_____  \  |    |    
   |    __)_ \  \/  /\____ \ |  |  |  |_/ ___\ \__  \  \   __\|  | /  _ \  /    \  /  ___/   \_____  \  /  / \  \ |    |    
   |        \ >    < |  |_> >|  |__|  |\  \___  / __ \_ |  |  |  |(  <_> )|   |  \ \___ \    /        \/   \_/.  \|    |___ 
  /_______  //__/\_ \|   __/ |____/|__| \___  >(____  / |__|  |__| \____/ |___|  //____  >  /_______  /\_____\ \_/|_______ \
          \/       \/|__|                   \/      \/                         \/      \/           \/        \__>        \/  */

/* Ce fichier contient contient toutes les explications SQL des différents points trouvables dans la cahier des charges. */
...
/* 2.   Gestion des utilisateurs.
        ...
        Il nous est demandé de créer différents utilisateur pour intéragir avec la base de donnée. Les voici : 
            - Le joueur
            - Le gestionnaire de boutique
            - L'administrateur
        A noter que plusieurs utilisateurs peuvent être joueur, gestionnaire de boutique ou administrateur. Pour cette raison l'utilisation de rôle
        est plus adaptée. Cela me permet de définir une seule fois les privilèges nécessaires. Ensuite, je peux créer les utilisateurs et leur attribuer ces rôles.
        De cette manière, tous les privilèges nécessaires sont regroupés dans un seul mot : le rôle.*/

        --Sélectionner la base de donnée à utiliser
        ...
        --Vérifier les privilèges de chaque rôle (OPTIONNEL)
...
/*3.    Requêtes de sélection 
        ...
        /* Dans cette partie, il nous est demandé de créer diverses requêtes spécifique. Ci-dessous se trouve donc l'explication détaillées de chaque requêtes. En premier temps,
        j'afficherai la consigne de la requête donnée par le chef de projet. Suivra ensuite la requête, puis finalement une 
